...
<div class="section scrollspy no-pad" id="about">
    ...
    <div class="container">
        ...
        <ul class="about-list browser-default">
            <li>
                <p class="flow-text">Вы сможете выбрать для себя оптимальное соотношение “цена - качество”. Мы предлагаем множество объектов по доступной цене.
            </li>
            <li>
                <p class="flow-text">Вы будете жить в том районе, в котором сами захотите: у нас огромный выбор домов в Подмосковье - от Ленинградского до
                Носовихинского
                шоссе.
            </li>
            <li>
                <p class="flow-text">У вас будет определенное место жительства - на каждый участок есть право собственности, поэтому вы сможете прописаться в доме.
            </li>
            <li>
                <p class="flow-text ">Вам не надо переживать за обустройство жилья, мы строим дома в Подмосковье “под ключ” - выполняем всю внутреннюю
                отделку, заводим
                коммуникации. Вам остается только завезти мебель и заселяться!
            </li>
            <li><p class="flow-text ">После покупки, вы сможете жить в новом доме круглый год. Мы заботимся о том, чтобы у наших клиентов была возможность подъехать на
                машине
                ко всем объектам в любую погоду.
            </li>
            <li><p class="flow-text ">С нашим агентством недвижимости в Москве вы подберете дом с той инфраструктурой, которая нужна именно вам. Хотите
                жить рядом со
                школой,
            ...
            <li><p class="flow-text ">С вами работают опытные специалисты: у нас вы можете получить юридическое сопровождение сделок, помощь в оформлении ипотеки и другие
                услуги.
            </li>
            <li><p class="flow-text ">За время нашей работы уже более 100 человек стали счастливыми обладателями комфортных домов в Подмосковье.</li>
        </ul>
